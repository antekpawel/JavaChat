...
public class ChatController {
	...
	private BufferedReader inputBufferedReader; // bufor wejœciowy (dane odebrane z serwera)
	private PrintWriter outputPrintWriter; // bufor wyjœciowy (dane do wys³ania)
	private final int PROTOCOL_PREFIX_LENGTH = 3; // d³ugoœæ s³ów kluczowych komunikatów
